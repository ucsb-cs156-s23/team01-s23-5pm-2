...
describe("MovieIndexPage tests", () => {
    ...
    test("renders correct fields", () => {
        ...
        const name = screen.getByText("Top Gun: Maverick");
        expect(name).toBeInTheDocument();

        const releasedate = screen.getByText("July 21, 2023");
    ...
    test("delete button calls delete and reloads page", async () => {
        ...
        const expectedMessage = `MovieIndexPage deleteCallback: {"id":3,"name":"Top Gun: Maverick","releasedate":"July 21, 2023","director":"Joseph Kosinski"}`;
